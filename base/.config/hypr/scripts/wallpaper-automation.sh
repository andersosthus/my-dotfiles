...
sec=$(cat ~/.config/andersosthus/settings/wallpaper-automation.sh)
...
if [ ! -f ~/.config/andersosthus/cache/wallpaper-automation ]; then
    touch ~/.config/andersosthus/cache/wallpaper-automation
    ...
    rm ~/.config/andersosthus/cache/wallpaper-automation
