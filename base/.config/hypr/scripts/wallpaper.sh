...
if [ -f ~/.config/andersosthus/settings/wallpaper_cache ]; then
    use_cache=1
...
force_generate=0
generatedversions="$HOME/.config/andersosthus/cache/wallpaper-generated"
waypaperrunning=$HOME/.config/andersosthus/cache/waypaper-running
cachefile="$HOME/.config/andersosthus/cache/current_wallpaper"
blurredwallpaper="$HOME/.config/andersosthus/cache/blurred_wallpaper.png"
squarewallpaper="$HOME/.config/andersosthus/cache/square_wallpaper.png"
rasifile="$HOME/.config/andersosthus/cache/current_wallpaper.rasi"
blurfile="$HOME/.config/andersosthus/settings/blur.sh"
defaultwallpaper="$HOME/wallpaper/default.jpg"
wallpapereffect="$HOME/.config/andersosthus/settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat $blurfile)
